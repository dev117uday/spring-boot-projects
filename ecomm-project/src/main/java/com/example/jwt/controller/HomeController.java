...
public class HomeController {
	...
	@Autowired
	public HomeController(JWTUtility jwtUtility, UserServiceToRepo userServiceToRepo) {
		this.jwtUtility = jwtUtility;
		this.userServiceToRepo = userServiceToRepo;
	}
	...
	public JwtResponse authenticate(@RequestBody JwtRequest jwtRequest) throws ExceptionBroker {
		...
		userServiceToRepo.insertUserService(user, jwtRequest.getUserName());
